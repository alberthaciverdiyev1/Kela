(function () {
    ...
    let PATHS = {
        ...
        'students': '<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>',
        ...
        'megaphone': '<path d="M3 10v4a1 1 0 0 0 1 1h2l5 4V5L6 9H4a1 1 0 0 0-1 1z"/><path d="M14 8a5 5 0 0 1 0 8"/>',
        ...
        'folder-plus': '<path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/><line x1="12" y1="11" x2="12" y2="17"/><line x1="15" y1="14" x2="9" y2="14"/>',
    ...
    Kela.icon = function (name, cls) {
        let c = cls ? ' class="' + cls + '"' : '';
        let paths = PATHS[name] || PATHS['students'];
        return '<svg' + c + ' viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="20" height="20">' + paths + '</svg>';
    };
