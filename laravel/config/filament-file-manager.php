...
return [
    ...
    */
    ...
    'thumbnails' => [
        // Bu sistemde GD PHP uzantısı yüklü değil (php-gd paketi kurulamıyor, sudo yok).
        // Bu yüzden küçük resim üretimi kapalıdır. SafeThumbnailService, GD ImageManager
        // yerine hiçbir görsel kütüphanesi başlatmadan thumbnail isteklerini null döndürür.
        'enabled' => false,
