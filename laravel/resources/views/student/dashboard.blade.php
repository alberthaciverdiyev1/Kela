...
<div class="space-y-6">
    ...
    <div class="grid gap-4 sm:grid-cols-2">
        <div class="rounded-xl border border-base-300/80 bg-base-100 p-5 transition-colors hover:border-primary/25">
            <span class="flex size-11 items-center justify-center rounded-lg bg-primary text-white">
                <x-icon name="heroicon-o-academic-cap" class="size-5" />
            </span>
            <h2 class="mt-3 font-semibold text-base-content">Dərslər</h2>
            <p class="mt-1 text-sm text-base-content/60">Dərslərinizi buradan davam etdirin.</p>
            <a href="#" class="mt-3 inline-flex items-center text-sm font-medium text-primary hover:underline">
                Keç
            </a>
        </div>
        <div class="rounded-xl border border-base-300/80 bg-base-100 p-5 transition-colors hover:border-primary/25">
            <span class="flex size-11 items-center justify-center rounded-lg bg-violet-600 text-white">
                <x-icon name="heroicon-o-pencil-square" class="size-5" />
            </span>
            <h2 class="mt-3 font-semibold text-base-content">Qeydlər</h2>
            <p class="mt-1 text-sm text-base-content/60">Qeydlərinizi yazın, rəngləyin və sabitləyin.</p>
            <a href="{{ route('student.notes.index') }}" class="mt-3 inline-flex items-center text-sm font-medium text-primary hover:underline">
                Keç
            </a>
        </div>
    </div>
