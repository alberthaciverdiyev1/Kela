...
>
    ...
    {{-- Quiz daşı dialog --}}
    <x-teacher.modal show="showQuizMove" title="Quiz-i qovluğa daşı" maxWidth="md">
        ...
        <x-slot:footer>
            <button type="button" class="btn btn-ghost" @click="showQuizMove = false">Ləğv et</button>
            <x-teacher.button @click="saveQuizMove()">Daşı</x-teacher.button>
        </x-slot:footer>
    </x-teacher.modal>
