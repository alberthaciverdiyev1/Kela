<template>
  <div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      <StatCard icon="pi pi-book" icon-bg-class="bg-primary-50 text-primary" label="Kurslar" :value="0" />
      <StatCard icon="pi pi-users" icon-bg-class="bg-success-50 text-success-600" label="Öğrenciler" :value="0" />
