<template>
  <div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      <StatCard icon="pi pi-book" icon-bg-class="bg-primary-50 text-primary" :label="i18n.t('nav.myCourses')" :value="0" />
      <StatCard icon="pi pi-check-circle" icon-bg-class="bg-success-50 text-success-600" :label="i18n.t('nav.attendance')" :value="0" />
      <StatCard icon="pi pi-star" icon-bg-class="bg-warning-50 text-warning-600" :label="i18n.t('nav.grades')" :value="0" />
    </div>
