<template>
  <Card class="max-w-2xl mx-auto border-none shadow rounded-2xl">
    <template #content>
      <div class="text-center py-10">
        <div class="w-16 h-16 mx-auto rounded-full bg-primary-50 text-primary flex items-center justify-center mb-4">
