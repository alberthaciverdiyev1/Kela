<template>
  <div class="max-w-4xl mx-auto">
    <!-- Başlık -->
    <div class="mb-6">
      <h1 class="text-2xl font-bold text-surface-800 mb-1">Site Tasarımı</h1>
      <p class="text-surface-500">
        Sitenin tamamında kullanılan anlamsal renkler buradan değiştirilir. Bir rengi değiştirmek
        butonlardan kartlara, formlardan rozetlere kadar tüm siteye anında yansır.
      </p>
    </div>
